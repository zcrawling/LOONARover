...
def main():
    ...
    cap.release()
    result=dict(frames=count,expected_frames=len(rows),axes=report,note='Offline measurement replay only; no motion executed. Not a full-distance accuracy validation.')
