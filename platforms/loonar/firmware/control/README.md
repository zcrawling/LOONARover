...
이 디렉터리는 Teensy 4.1용 Control MCU firmware 기준 구현이다. Wire 규격의 기준은
[`control_mcu_wire_v1.md`](../../interfaces/control_mcu_wire_v1.md)다. 이 구현은
최종 LOONAR 플랫폼 자산이며, Vehicle Gateway 이관 전 v1 reference 상태다.
