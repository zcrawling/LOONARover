...
'J4':(109.2,141,270),'R300':(114,147,0),'R301':(114,140,0),'R302':(115,143,90),'C300':(118,140,90),
'U300':(123,141,0),'U301':(123,131,180),'R303':(119,134,0),'C301':(119,136,0),'C302':(127,145.7,90),'C303':(127,132,90),
'U302':(119,124,0),'R304':(124.5,120.8,0),'R305':(124.5,123,0),'C304':(115,125,90),'C305':(124,127,0),
'TP300':(112,145,0),'TP301':(115,136,0),'TP302':(108,131,0),'TP303':(108,149,0),'SH1':(132,151,0),
}
...
for ref in list(pos):
 if ref[0] in 'URCD' and ref[1:].isdigit() and 100<=int(ref[1:])<300 or ref in ['TP100','TP200']:
  x,y,a=pos[ref];pos[ref]=(x-5,y,a)
pos.update({'J2':(155.8,124,90),'J3':(155.8,145,90),'R200':(129,134.5,90),'R202':(132,145,0),'R102':(130,124.5,0),'R8':(120,119.6,90),'R300':(115,148.8,0),'R301':(115,140,0),'TP300':(116,151,0)})
