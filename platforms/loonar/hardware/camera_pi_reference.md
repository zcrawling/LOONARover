# LOONAR Pi Camera Hardware Reference

이 문서는 최종 LOONAR의 Raspberry Pi Camera Module 3, libcamera/GStreamer 관련
제약을 보존한다. LIMO camera driver는 `platforms/limo/`에만 추가하며, 공통
Camera control/data-plane 원칙은 새 시스템 문서에서 정의한다.
